...
\end{ex}
\begin{proof}[Answer]
This result is a modification of the proof of Theorem \ref{2.3.1}.
\begin{align*}
...
Let $X \sim \text{Poisson}(\lambda)$. Show that for $t > \mu$
\begin{align*}
...
Let $X \sim \text{Poisson}(\lambda)$. Show that as $k\to\infty$
\begin{align*}
